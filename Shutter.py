...
class Shutter(Objet):
    ...
    courseTime  = 5;       # (seconds) max. time for shutter to get fully open / close
    ...
    def __init__(self, unitID,mqtt_pub_topic="1r1/014/shutter",mqtt_sub_topic="1r1/014/shutter/command",mqtt_server="192.168.0.206",mqtt_port=1883,shutterType="wired", courseTime=5, io_backend=None, upOutput=None, downOutput=None, stopOutput=None, shutdown_event=None, *args, **kwargs):
        ''' Initialize object '''
    ...
    def on_message(self, client, userdata, msg):
        ...
        if((payload['dest'] == "all") or (payload['dest'] == self.unitID)):
            if payload['order']=="Up":
